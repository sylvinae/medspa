...
const ContactUs: React.FC = () => {
  return (
    <section className="bg-[#2C2429] text-[#D3D3D3] py-[5rem] px-[5rem]">
      <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
        {/* Left Side - Contact Info + Map */}
        <div>
          <h2 className="text-6xl font-bold font-[Cormorant] tracking-widest text-[#F6F6D7]">
            CONTACT US
          </h2>

          {/* Contact Details */}
          <div className="mt-6 space-y-3 text-lg text-[#D3D3D3] leading-relaxed">
            <p>
            ...
            <p className="flex items-center space-x-2">
              ...
              <a
                ...
                className="flex items-center space-x-2 text-[#F8EDEB] hover:text-[#C6A79F] transition"
              >
          ...
          {/* Google Map Embed */}
          <iframe
            className="w-140 h-96 mt-4 rounded-lg shadow-lg"
        ...
        <div className="flex flex-col items-start">
          <form className="space-y-6 w-full max-w-[450px]">
            <input
              type="text"
              placeholder="Full Name"
              className="w-full bg-transparent border-b border-[#D3D3D3] text-lg text-[#D3D3D3] py-2 focus:outline-none placeholder-[#D3D3D3]"
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <textarea
              ...
              className="w-full bg-transparent border-b border-[#D3D3D3] text-lg text-[#D3D3D3] py-2 focus:outline-none placeholder-[#D3D3D3] resize-none h-40"
            />

            {/* Button Wrapper to Align with Inputs */}
            <div className="w-full flex justify-start">
              <button
                type="submit"
                className="bg-[#E0C7C2] text-black px-6 py-3 text-lg rounded-md shadow-md hover:bg-[#D6B5AF] transition"
              >
                Send Message
              </button>
            </div>
